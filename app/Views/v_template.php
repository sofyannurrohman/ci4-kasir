...
<head>
  ...
  <script src="src/AutoNumeric.js"></script>
<!-- jQuery -->
...
<script src="plugins/numeric/src/AutoNumeric.js"></script>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="/admin" class="d-block">Hello, <?= session()->get('nama_user'); ?></a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item <?= $menu=='masterdata'? 'menu-open' : ''; ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/transaksi" class="nav-link  <?= $submenu=='transaksi'? 'active' : ''; ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Transaksi</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/produk" class="nav-link  <?= $submenu=='barang'? 'active' : ''; ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Barang</p>
                </a>
              </li>
